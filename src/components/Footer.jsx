      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-white">Política de Privacidad</a></li>
              <li><a href="#" className="text-white/70 hover:text-white">Términos y Condiciones</a></li>
              <li><a href="#" className="text-white/70 hover:text-white">Aviso Legal</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70 text-sm mb-4">
              <li>Virgen Stella Maris 4474</li>
              <li>Córdoba, Argentina</li>
              <li>Tel: 351 730 0674</li>
              <li>aducmaasociacion@gmail.com</li>
            </ul>
            ...
            <div className="flex gap-3">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/543517300674" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
